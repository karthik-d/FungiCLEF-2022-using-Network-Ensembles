...
weight_save = keras.callbacks.ModelCheckpoint('weights/weights-efficientnetb4/weights-epoch-2_{epoch:03d}.h5', save_weights_only=True, period=1)
on_epoch_end_call = keras.callbacks.LambdaCallback(on_epoch_end=data_reader.on_epoch_end())

model2.load_weights('/home/miruna/LifeCLEF/FungiCLEF/weights/weights-efficientnetb4/weights-epoch-1_007.h5')
