...
model = ResNet101(weights='imagenet', include_top=False, input_shape=(*IMG_SIZE, 3))
...
weight_save = keras.callbacks.ModelCheckpoint('weights/weights-resnet101/weights-epoch-{epoch:05d}.h5', save_weights_only=True, period=1)
on_epoch_end_call = keras.callbacks.LambdaCallback(on_epoch_end=data_reader.on_epoch_end())

model2.load_weights('weights/weights-resnet101/weights-epoch-4_009.h5')
